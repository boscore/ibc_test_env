...
http-server-address = 0.0.0.0:9002
blocks-dir = blocks
...
read -d '' config03 << EOF
http-server-address = 0.0.0.0:8903
...
read -d '' config05 << EOF
http-server-address = 0.0.0.0:8905
...
read -d '' config06 << EOF
http-server-address = 0.0.0.0:8906
...
read -d '' config07 << EOF
http-server-address = 0.0.0.0:8907
...
read -d '' config08 << EOF
http-server-address = 0.0.0.0:8908
...
read -d '' config09 << EOF
http-server-address = 0.0.0.0:8909
...
read -d '' config10 << EOF
http-server-address = 0.0.0.0:8910
...
read -d '' config11 << EOF
http-server-address = 0.0.0.0:8911
...
EOF
read -d '' config12 << EOF
http-server-address = 0.0.0.0:8912
...
EOF
read -d '' config13 << EOF
http-server-address = 0.0.0.0:8913
...
EOF
read -d '' config14 << EOF
http-server-address = 0.0.0.0:8914
...
EOF
read -d '' config15 << EOF
http-server-address = 0.0.0.0:8915
...
EOF
read -d '' config16 << EOF
http-server-address = 0.0.0.0:8916
...
EOF
read -d '' config17 << EOF
http-server-address = 0.0.0.0:8917
...
EOF
read -d '' config18 << EOF
http-server-address = 0.0.0.0:8918
...
EOF
read -d '' config19 << EOF
http-server-address = 0.0.0.0:8919
...
EOF
read -d '' config20 << EOF
http-server-address = 0.0.0.0:8920
...
EOF
read -d '' config21 << EOF
http-server-address = 0.0.0.0:8921
...
EOF
read -d '' config22 << EOF
http-server-address = 0.0.0.0:8922
...
EOF
read -d '' config23 << EOF
http-server-address = 0.0.0.0:8923
...
EOF
read -d '' config24 << EOF
http-server-address = 0.0.0.0:8924
...
EOF
read -d '' config25 << EOF
http-server-address = 0.0.0.0:8925
...
EOF
read -d '' config26 << EOF
http-server-address = 0.0.0.0:8926
...
EOF
read -d '' config27 << EOF
http-server-address = 0.0.0.0:8927
...
EOF
read -d '' config28 << EOF
http-server-address = 0.0.0.0:8928
...
EOF
read -d '' config29 << EOF
http-server-address = 0.0.0.0:8929
...
EOF
read -d '' config30 << EOF
http-server-address = 0.0.0.0:8930
...
EOF
read -d '' config31 << EOF
http-server-address = 0.0.0.0:8931
...
EOF
read -d '' config32 << EOF
http-server-address = 0.0.0.0:8932
...
EOF
read -d '' config33 << EOF
http-server-address = 0.0.0.0:8933
...
EOF
read -d '' config34 << EOF
http-server-address = 0.0.0.0:8934
...
EOF
read -d '' config35 << EOF
http-server-address = 0.0.0.0:8935
...
EOF
read -d '' config36 << EOF
http-server-address = 0.0.0.0:8936
...
EOF
read -d '' config37 << EOF
http-server-address = 0.0.0.0:8937
...
EOF
read -d '' config38 << EOF
http-server-address = 0.0.0.0:8938
...
EOF
read -d '' config39 << EOF
http-server-address = 0.0.0.0:8939
...
EOF
read -d '' config40 << EOF
http-server-address = 0.0.0.0:8940
...
EOF
read -d '' config41 << EOF
http-server-address = 0.0.0.0:8941
...
EOF
read -d '' config42 << EOF
http-server-address = 0.0.0.0:8942
...
EOF
read -d '' config43 << EOF
http-server-address = 0.0.0.0:8943
...
EOF
read -d '' config44 << EOF
http-server-address = 0.0.0.0:8944
...
EOF
read -d '' config45 << EOF
http-server-address = 0.0.0.0:8945
...
EOF
read -d '' config46 << EOF
http-server-address = 0.0.0.0:8946
...
EOF
read -d '' config47 << EOF
http-server-address = 0.0.0.0:8947
...
EOF
read -d '' config48 << EOF
http-server-address = 0.0.0.0:8948
...
EOF
read -d '' config49 << EOF
http-server-address = 0.0.0.0:8949
...
EOF
read -d '' config50 << EOF
http-server-address = 0.0.0.0:8950
...
EOF
read -d '' config51 << EOF
http-server-address = 0.0.0.0:8951
