...
init_contracts_2(){
    $cleos1 push action ${contract_token} setglobal '["ibc2chain555","'${chain_B_name}'","ibc2token555",0,1000,5,true]' -p ${contract_token}
    $cleos2 push action ${contract_token} setglobal '["ibc2chain555","'${chain_A_name}'","ibc2token555",0,1000,5,true]' -p ${contract_token}
}
init_contracts_2
